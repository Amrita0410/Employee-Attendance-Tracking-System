package com.Azentio.EmployeeAttendanceTracking.Repository;
...
public interface EmployeeRepository extends JpaRepository<EmployeeModel, Long>
{
    ...
    @Modifying
    @Transactional
    @Query("UPDATE EmployeeModel e SET e.hourlyRate = :hourlyRate WHERE e.position = :position")
    void updateHourlyRateByPosition(@Param("position") String position, @Param("hourlyRate") double hourlyRate);
